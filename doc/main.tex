...
\namespace*{lvar}{
  ...
  \providecommand{\do}[3]{\ensuremath{\mathbf{do}\;\{x_{1} \leftarrow #1, ... ,x_{n} \leftarrow #2\}_{n \geq 1}\mathbf{in}\;#3}}
  \providecommand{\do1}[4]{\ensuremath{\mathbf{do}\;\{x_{#1} \leftarrow #2, ... ,x_{n} \leftarrow #3\}_{n \geq 1}\mathbf{in}\;#4}}
