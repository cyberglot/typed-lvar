  ...
  \begin{mathpar}
    ...
    \begin{array}{llrl}
      ...
      \LabTirName{E-New}     & \tm{\config{\lvarnew}{S}}
                             & \red
                             & \tm{\config{l}{S, l \mapsto\state{0}{\botD}}}
      \\
      \LabTirName{E-Freeze}  & \tm{\config{\lvarfreeze}{S, l \mapsto\state{b}{d}}}
                             & \red
                             & \tm{\config{d}{S, l \mapsto\state{1}{d}}}
      \\
      \LabTirName{E-Put}     & \tm{\config{\lvarput\;l\;d'}{S, l \mapsto\state{\false}{d}}}
                             & \red
                             & \tm{\config{()}{S, l \mapsto\state{\false}{d'}}}
      \\
      \LabTirName{E-Get}     & \tm{\config{\lvarget\;l\;J}{S, l \mapsto\state{b}{d}}}
                             & \red
                             & \tm{\config{d'}{S, l \mapsto\state{b}{d}}}
    \end{array}
  \end{mathpar}
  \end{minipage}%
