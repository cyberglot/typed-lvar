...
\namespace*{lvar}{
  ...
  \providecommand{\tyL}[1]{\ensuremath{\ty{\mathcal{L}_{\mathcal{D}}^{#1}}}}
  ...
  \providecommand{\sts}[2]{\ensuremath{\langle {#1},\;{#2} \rangle}}
  \providecommand{\config}[2]{\ensuremath{\langle {#1}\;\vert\;{#2} \rangle}}
  \providecommand{\confige}[2]{\ensuremath{\langle E\lbrack {#1} \rbrack \; \vert\;{#2} \rangle}}
  \providecommand{\configl}[2]{\ensuremath{\langle {#1} \; ; \;{#2} \rangle}}
  % evaluation contexts
  ...
  \providecommand{\rede}[0]{\ensuremath{\longrightarrow_{E}}}
  \providecommand{\lred}[0]{\ensuremath{\hookrightarrow}}
  \providecommand{\lrede}[0]{\ensuremath{\mapsto}}
  % bottom and top
  \providecommand{\topD}{{\top_{\scriptscriptstyle\mathcal{D}}}}
  \providecommand{\botD}{{\bot_{\scriptscriptstyle\mathcal{D}}}}
  % join operators
  \providecommand{\sqcupD}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle\mathcal{D}}}}}
  \providecommand{\sqcupT}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle{T}}}}}
  \providecommand{\sqcupG}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle\Gamma}}}}
  \providecommand{\sqcupB}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle{B}}}}}
  \providecommand{\sqcups}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle{s}}}}}
  \providecommand{\sqcupS}{\mathbin{{\color{black}\sqcup_{\scriptscriptstyle{S}}}}}
  % partial orders
  \providecommand{\sqsubseteqD}{\mathbin{{\color{black}\sqsubseteq_{\scriptscriptstyle\mathcal{D}}}}}
  \providecommand{\sqsubseteqJ}{\mathbin{{\color{black}\sqsubseteq_{\scriptscriptstyle\mathcal{J}}}}}
}{}
\newcommand{\lvar}[1]{\namespace*{lvar}{}{#1}}
