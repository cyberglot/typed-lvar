...
\begin{mathpar}
  ...
  \end{cases}
  \\
  \ty{\tyL{\frz}{l,u}}\sqcup\ty{\tyL{\frz}{l,u'}}
  =
  \ty{\tyL{\frz}{{l},{u}\sqcup{u'}}}
  \\
  \ty{\Sigma}\sqsubseteq\ty{\Sigma'}
  =
  \forall(\ty{\ell}\in\dom({\ty{\Sigma}})).\ty{\Sigma(\ell)}\sqsubseteq\ty{\Sigma'(\ell)}
  \\
  \ty{\tyL{\frz}{l,u}}\sqsubseteq\ty{\tyL{\frz'}{l',u'}}
  =
  \ty{\frz}\sqsubseteq\ty{\frz'}\text{ and }\ty{l}\sqsubseteq\ty{l'}\sqsubseteq\ty{u}\sqsubseteq\ty{u'}
\end{mathpar}
