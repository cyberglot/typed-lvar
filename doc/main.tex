...
\namespace*{lvar}{
  ...
  \providecommand{\tyfun}[3][]{\ensuremath{{#2}\mathbin{\ty{\xrightarrow{#1}}}{#3}}}
  \providecommand{\tyD}[1]{\ensuremath{\ty{\mathcal{D}^{#1}}}}
  \providecommand{\tyL}[2]{\ensuremath{\ty{\mathcal{L}_{#1}^{#2}}}}
  \providecommand{\tySource}[2]{\ensuremath{\ty{\mathbf{Source}_{#1}^{#2}}}}
  \providecommand{\tySink}[2]{\ensuremath{\ty{\mathbf{Sink}_{#1}^{#2}}}}
  \providecommand{\tyRef}[2]{\ensuremath{\ty{\mathbf{Ref}_{#1}^{#2}}}}
  ...
  % typing judgements
  \providecommand{\seq}[4]{\ensuremath{#1\mathbin{{\vert}}#2\mathbin{{\vdash}}\tmty{#3}{#4}}}
